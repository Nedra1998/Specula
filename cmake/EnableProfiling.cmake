...
#
# enable_profiling(<targetname>) globally_enable_profiling() - to modify
# CMAKE_CXX_FLAGS, etc to change for all targets declared after the command,
...
macro(_enable_profiling_flags)
  set(_flags)
  if(MSVC)
    # TODO: what kind of flags are needed to profile on MSVC? set(_flags /W4)
